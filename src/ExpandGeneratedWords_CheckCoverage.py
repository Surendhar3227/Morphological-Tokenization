...
def main():
    ...
    output_dir = [COMPLETED_MORPH_OUTPUT_DIR]
    ...
    print(f"The total Number of words in the common lit is {len(common_words_list)}")
    ...
    chunk_index=1
    for suffix in tqdm(Other_suffixes, desc=f"Single Suffix", position=0):
        chunk_index+=1
